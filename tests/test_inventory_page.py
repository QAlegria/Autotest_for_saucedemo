...
def test_inventory_page_default_state_objects(inventory_page_with_standard_user):
    ...
    inventory_page_with_standard_user.button_add_to_cart_by_index_is_displayed(0)
    inventory_page_with_standard_user.sort_is_displayed()
...
def test_product_sort(inventory_page_with_standard_user):
    ...
    inventory_page_with_standard_user.select_a_to_z_sort()
    inventory_page_with_standard_user.check_products_is_a_to_z_sorted()

def test_first_product_add_to_cart_and_remove(inventory_page_with_standard_user):
    inventory_page_with_standard_user.check_product_counter_icon_is_not_displayed()
    inventory_page_with_standard_user.button_add_to_cart_by_index_is_displayed(0)
    inventory_page_with_standard_user.click_button_add_to_card_product_by_index(0)
    inventory_page_with_standard_user.check_product_counter_icon_is(1)
    inventory_page_with_standard_user.click_button_remove_from_cart_product_by_index(0)
    inventory_page_with_standard_user.check_product_counter_icon_is_not_displayed()

def test_add_and_remove_random_products(inventory_page_with_standard_user):
    inventory_page_with_standard_user.check_product_counter_icon_is_not_displayed()
    inventory_page_with_standard_user.add_random_products_to_cart()
    inventory_page_with_standard_user.check_product_counter_icon_is_equals_random_selected_products()
    inventory_page_with_standard_user.remove_random_products_from_cart()
    inventory_page_with_standard_user.check_product_counter_icon_is_equals_selected_minus_removed_products()
    sleep(2)
